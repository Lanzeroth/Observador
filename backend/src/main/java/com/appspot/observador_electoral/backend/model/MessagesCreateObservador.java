...
public final class MessagesCreateObservador extends com.google.api.client.json.GenericJson {
     ...
     */
    public MessagesCreateObservador setAccountType(java.lang.String accountType) {
     ...
     */
    public MessagesCreateObservador setAge(java.lang.Long age) {
        this.age = age;
        return this;
    }
     ...
     */
    public MessagesCreateObservador setEmail(java.lang.String email) {
        this.email = email;
        return this;
    }
     ...
     */
    public MessagesCreateObservador setInstallationId(java.lang.String installationId) {
     ...
     */
    public MessagesCreateObservador setName(java.lang.String name) {
        this.name = name;
        return this;
    }

    @Override
    public MessagesCreateObservador set(String fieldName, Object value) {
        return (MessagesCreateObservador) super.set(fieldName, value);
    }

    @Override
    public MessagesCreateObservador clone() {
        return (MessagesCreateObservador) super.clone();
    }
